...
#define AI_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 120, 160, 1, 1, NULL), \
}
#define AI_NETWORK_IN_SIZE { \
  (120 * 160 * 1), \
}
#define AI_NETWORK_IN_1_SIZE  (120 * 160 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  ((120 * 160 * 1) * 1)
...
#define AI_NETWORK_OUT_1_SIZE  (1 * 1 * 2)
#define AI_NETWORK_OUT_1_SIZE_BYTES  ((1 * 1 * 2) * 1)
